...
import org.xtext.demo.dsl.ide.ExpressionLangLanguageServerImpl;
...
public class LanguageServerModule extends AbstractModule {
    protected void configure() {
        ...
        this.bind(LanguageServer.class).to(ExpressionLangLanguageServerImpl.class);
